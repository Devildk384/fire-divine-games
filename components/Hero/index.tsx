...
const Hero = () => {
  return (
    <div className="mt-20 lg:mt-0 min-h-60 sm:min-h-96 xl:min-h-[50vh] w-full px-5 md:px-[60px] py-10 max-w-screen-md 2xl:max-w-screen-xl 3xl:max-w-screen-2xl mx-auto grid grid-cols-2">
      <div className="flex flex-col gap-4 items-center justify-center text-primary">
        <h1 className="text-primary text-xl">Fire Divine Games</h1>
